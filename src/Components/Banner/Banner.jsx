...
const Banner = () => {
    return (
        ...
        <div className='lg:flex space-y-3 justify-center '>
        ...
        <div className=' lg:flex gap-5 justify-center space-y-5 px-5'>
            ...
            <img  className='w-150 lg:h-90' src="https://i.ibb.co.com/vC1zNR0F/banner-img-1.png" alt="doctors" />
            <img className='w-150 rounded-2xl lg:h-90' src="https://i.ibb.co.com/tG6Yprj/couple.jpg" alt="doctors" />
        </div>
        </div>
    );
};
